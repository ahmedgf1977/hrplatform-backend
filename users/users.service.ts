...
export class UsersService {
  ...
  findAll() {
    return this.repo.find({ select: { id:true, name:true, email:true, role:true, company:true, active:true, lastLogin:true, createdAt:true, position:true, area:true, department:true, manager:true, phone:true } });
  }
